...
from opendataval.dataval import (
    ...
    ModelDeviationWithSingularEvaluator
)
...
def main():
    ...
    domains = ["Books", "Electronics", "Home_and_Kitchen"]
    ...
    for test_domain in domains:
        ...
        # 1. Load embeddings and labels for train domains
        train_embeddings = []
        train_labels = []
        ...
        dataset_name = f"Amazon_LOO_{test_domain}"
        ...
        data_evaluators = [ 
            ...
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0, epsilon_weight = 1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0, epsilon_weight = -1),
            ...
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 2, epsilon_weight = 1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 2, epsilon_weight = -1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 2, epsilon_weight = 0.1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 2, epsilon_weight = -0.1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 2, epsilon_weight = 0.01),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 2, epsilon_weight = -0.01),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 2, epsilon_weight = 0.001),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 2, epsilon_weight = -0.001),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = -2, epsilon_weight = 0.1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = -2, epsilon_weight = -0.1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = -2, epsilon_weight = 0.01),
            ...
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.1, epsilon_weight = 0.1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.1, epsilon_weight = -0.1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.1, epsilon_weight = 0.01),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.1, epsilon_weight = -0.01),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.1, epsilon_weight = 0.001),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.1, epsilon_weight = -0.001),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.01, epsilon_weight = 0.1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.01, epsilon_weight = -0.1),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.01, epsilon_weight = 0.01),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.01, epsilon_weight = -0.01),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.01, epsilon_weight = 0.001),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = 0.01, epsilon_weight = -0.001),
            ...
            weightsingularKNNShapley(k_neighbors=valid_size, weight = -0.01, epsilon_weight = 0.001),
            weightsingularKNNShapley(k_neighbors=valid_size, weight = -0.01, epsilon_weight = -0.001),
            ModelDeviationWithSingularEvaluator(weight = 1, epsilon_weight = 0.01),
            ModelDeviationWithSingularEvaluator(weight = 1, epsilon_weight = -0.01),
            ModelDeviationWithSingularEvaluator(weight = 1, epsilon_weight = 0.001),
            ModelDeviationWithSingularEvaluator(weight = 1, epsilon_weight = -0.001),
            ModelDeviationWithSingularEvaluator(weight = 0, epsilon_weight = 0.01),
            ModelDeviationWithSingularEvaluator(weight = 0, epsilon_weight = -0.01),
            ModelDeviationWithSingularEvaluator(weight = 0, epsilon_weight = 0.001),
            ModelDeviationWithSingularEvaluator(weight = 0, epsilon_weight = -0.001),
            ModelDeviationEvaluator()
        ]
